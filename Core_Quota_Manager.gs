...
var QuotaManager = (function() {
  ...
  function getOperationCounts() {
    try {
      ...
      Logger.log("Erro em getOperationCounts: " + error.message);
      throw error;
    }
  }
  ...
  function saveDailyUsage(usage) {
    try {
      try {
        ...
        Logger.log("Erro em saveDailyUsage: " + error.message);
        throw error;
      }
    } catch (error) {
      Logger.log("Erro em saveDailyUsage: " + error.message);
  ...
  function generateAlerts(usage, elapsed, emailQuota) {
    try {
      ...
      Logger.log("Erro em generateAlerts: " + error.message);
      throw error;
    }
  }
...
function exibirRelatorioCotas() {
  try {
    ...
    Logger.log("Erro em exibirRelatorioCotas: " + error.message);
    throw error;
  }
}
