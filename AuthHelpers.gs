...
const SGAE_AUTH_CONFIG_ = {
  SESSION_KEY_PREFIX: 'SGAE_SESSION_',
...
// ============================================================================
// Rotina 5: implementação legada privada de loginWithToken
// ============================================================================
 ...
 */
function AuthHelpers_loginWithToken_(username, password) {
  try {
    try {
      try {
        try {
          ...
          const session = {
            ...
            email: user.email,
            issuedAt: Date.now(),
            expiresAt: Date.now() + (SGAE_AUTH_CONFIG_.SESSION_TTL_SECONDS * 1000)
          };
    
          PropertiesService.getScriptProperties().setProperty(
            SGAE_AUTH_CONFIG_.SESSION_KEY_PREFIX + token,
...
// ============================================================================
// Rotina 6: implementação legada privada de isAuthenticatedByToken
// ============================================================================
 ...
 * @returns {boolean}
 */
function AuthHelpers_isAuthenticatedByToken_(tok) {
  try {
    try {
      if (!tok) return false;
  
      const key = SGAE_AUTH_CONFIG_.SESSION_KEY_PREFIX + tok;
...
// ============================================================================
// Rotina 7: implementação legada privada de getSessionUser
// ============================================================================
 ...
 */
function AuthHelpers_getSessionUser_(tok) {
  try {
    try {
      if (!tok) return null;
...
// ============================================================================
// Rotina 8: implementação legada privada de logoutWithToken
// ============================================================================
 ...
 */
function AuthHelpers_logoutWithToken_(tok) {
  try {
    try {
      try {
        if (tok) {
