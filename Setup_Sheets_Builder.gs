    ...
    try {
      try {
        ...
        if (!ss) {
          ...
          if (!id) {
            return { success: false, error: 'Planilha não encontrada. Configure SPREADSHEET_ID nas Script Properties.' };
          }
          try {
            ss = SpreadsheetApp.openById(id);
          } catch (e) {
            return { success: false, error: 'Não foi possível abrir planilha (' + id + '): ' + e.message };
          }
        }
        ...
        Logger.log("Erro em montarPlanilha: " + error.message);
...
function montarTodasPlanilhas() {
  try {
    ...
    Logger.log("Erro em montarTodasPlanilhas: " + error.message);
    throw error;
  }
}
...
function montarSistemaCompleto() {
  try {
    ...
    Logger.log("Erro em montarSistemaCompleto: " + error.message);
    throw error;
  }
}
...
function listarCredenciais() {
  try {
    ...
    Logger.log("Erro em listarCredenciais: " + error.message);
    throw error;
  }
}
...
function resetarPlanilha(sheetName) {
  try {
    ...
    Logger.log("Erro em resetarPlanilha: " + error.message);
    throw error;
  }
}
...
function resetarTodasPlanilhas() {
  try {
    ...
    Logger.log("Erro em resetarTodasPlanilhas: " + error.message);
    throw error;
  }
}
...
function criarMenuSetup() {
  try {
    ...
    Logger.log("Erro em criarMenuSetup: " + error.message);
    throw error;
  }
}
...
function migrarNotasFiscaisParaNovaEstrutura() {
  try {
    ...
    Logger.log("Erro em migrarNotasFiscaisParaNovaEstrutura: " + error.message);
    throw error;
  }
}
  ...
  try {
    try {
      try {
        ...
        Logger.log("Erro em atualizarHeadersNotasFiscais: " + error.message);
        throw error; // Re-lança para tratamento superior
      }
    } catch (error) {
      Logger.log("Erro em atualizarHeadersNotasFiscais: " + error.message);
...
function montarNutricaoCompleto() {
  try {
    ...
    Logger.log("Erro em montarNutricaoCompleto: " + error.message);
    throw error;
  }
}
...
function montarWorkflowsCompleto() {
  try {
    ...
    Logger.log("Erro em montarWorkflowsCompleto: " + error.message);
    throw error;
  }
}
...
function resetarWorkflows() {
  try {
    ...
    Logger.log("Erro em resetarWorkflows: " + error.message);
    throw error;
  }
}
...
function validarDadosTesteWorkflows() {
  try {
    ...
    Logger.log("Erro em validarDadosTesteWorkflows: " + error.message);
    throw error;
  }
}
...
function testeRapidoWorkflows() {
  try {
    ...
    Logger.log("Erro em testeRapidoWorkflows: " + error.message);
    throw error;
  }
}
