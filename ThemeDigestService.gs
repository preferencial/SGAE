 ...
 * ============================================================================
 * PROJETO: Preferencial - SGAE
 * TEMA: Alimentacao escolar (PNAE)
 *
 * DESCRIÇÃO:
...
var THEME_NEWS_CFG = {
  THEME: 'Alimentacao escolar (PNAE)',
  QUERY: '"alimentacao escolar" OR PNAE',
  AUDIENCE: 'a comunidade escolar atendida pelo atesto de generos alimenticios da CRE-PP',
