...
var PROJECT_SCHEMA_DEFINITIONS = {"ALUNOS_NAE":{"entity":"ALUNOS_NAE","sheetName":"Alunos_Nae","headers":["ID","Name","Email","Phone","Class","GuardianName","GuardianPhone","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"ALUNOS_NECESSIDADES_ESPECIAIS":{"entity":"ALUNOS_NECESSIDADES_ESPECIAIS","sheetName":"Alunos_Necessidades_Especiais","headers":["ID","Name","Email","Phone","Class","GuardianName","GuardianPhone","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"ANALISE_QUALIDADE":{"entity":"ANALISE_QUALIDADE","sheetName":"Analise_Qualidade","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Documentos.gs"},"ANALISES":{"entity":"ANALISES","sheetName":"Workflow_Analises","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Workflow_Repository.gs"},"ATRASOS_ENTREGAS":{"entity":"ATRASOS_ENTREGAS","sheetName":"Atrasos_Entregas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Documentos.gs"},"AUD_AUDITORIA":{"entity":"AUD_AUDITORIA","sheetName":"Aud_Auditoria","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"_INIT_Main.gs"},"AUD_AUDITORIA_ENTERPRISE":{"entity":"AUD_AUDITORIA_ENTERPRISE","sheetName":"AUD_Auditoria_Enterprise","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Enterprise_Audit.gs"},"AUDIT_LOG":{"entity":"AUDIT_LOG","sheetName":"Audit_Log","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Migrations.gs"},"AUDIT_LOGS":{"entity":"AUDIT_LOGS","sheetName":"Audit_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"AUDITORIA":{"entity":"AUDITORIA","sheetName":"Auditoria_Log","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"AUDITORIA_LOG":{"entity":"AUDITORIA_LOG","sheetName":"Auditoria_Log","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"AVALIACAO_FORNECEDORES":{"entity":"AVALIACAO_FORNECEDORES","sheetName":"Avaliacao_Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Fornecedores.gs"},"AVALIACOES_NUTRICIONISTA":{"entity":"AVALIACOES_NUTRICIONISTA","sheetName":"Avaliacoes_Nutricionista","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"CADASTROS":{"entity":"CADASTROS","sheetName":"Cadastros","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"CALCULO_GLOSAS":{"entity":"CALCULO_GLOSAS","sheetName":"Calculo_Glosas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Empenhos.gs"},"CARDAPIOS_BASE":{"entity":"CARDAPIOS_BASE","sheetName":"Cardapios_Base","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Builder.gs"},"CARDAPIOS_ESPECIAIS":{"entity":"CARDAPIOS_ESPECIAIS","sheetName":"Cardapios_Especiais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"CARDAPIOS_SEMANAIS":{"entity":"CARDAPIOS_SEMANAIS","sheetName":"Cardapios_Semanais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Builder.gs"},"CERTIDOES_FORNECEDORES":{"entity":"CERTIDOES_FORNECEDORES","sheetName":"Certidoes_Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"CHART_TEMP":{"entity":"CHART_TEMP","sheetName":"_ChartTemp","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"CHARTTEMP":{"entity":"CHARTTEMP","sheetName":"_Charttemp","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"UI_Standards.gs"},"COMISSAO_ATESTACOES":{"entity":"COMISSAO_ATESTACOES","sheetName":"Comissao_Atestacoes","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"COMISSAO_MEMBROS":{"entity":"COMISSAO_MEMBROS","sheetName":"Comissao_Membros","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Migrations.gs"},"CONF_CONFERENCIAS":{"entity":"CONF_CONFERENCIAS","sheetName":"CONF_Conferencias","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"CONFIG":{"entity":"CONFIG","sheetName":"Config","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"Core_Bootstrap_AE.gs"},"CONFIG_COMISSAO":{"entity":"CONFIG_COMISSAO","sheetName":"Config_Comissao","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"Infra_Configuracao.gs"},"CONFIG_MEMBROS_COMISSAO":{"entity":"CONFIG_MEMBROS_COMISSAO","sheetName":"Config_Membros_Comissao","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"Core_Schema_Definition.gs"},"CONFIG_TEXTOS_PADRAO":{"entity":"CONFIG_TEXTOS_PADRAO","sheetName":"Config_Textos_Padrao","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"Infra_Configuracao.gs"},"CONFIGURACOES":{"entity":"CONFIGURACOES","sheetName":"Configuracoes","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"Core_Constants_Sheets.gs"},"CONFORMIDADE":{"entity":"CONFORMIDADE","sheetName":"Conformidade","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"CONTRATOS":{"entity":"CONTRATOS","sheetName":"Contratos_Empenho","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Builder.gs"},"CONTRATOS_EMPENHO":{"entity":"CONTRATOS_EMPENHO","sheetName":"Contratos_Empenho","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"CONTROLE_CONFERENCIA":{"entity":"CONTROLE_CONFERENCIA","sheetName":"Controle_Conferencia","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"DESCARTES_ALIMENTOS":{"entity":"DESCARTES_ALIMENTOS","sheetName":"Descartes_Alimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Notificacao_Alimentos.gs"},"DIAGNOSTICO":{"entity":"DIAGNOSTICO","sheetName":"Diagnostico","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Infra_Diagnostico.gs"},"EMPENHOS":{"entity":"EMPENHOS","sheetName":"Empenhos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"ENTREGAS":{"entity":"ENTREGAS","sheetName":"Entregas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"ESC_ESCOLAS":{"entity":"ESC_ESCOLAS","sheetName":"ESC_Escolas","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"ESCOLAS":{"entity":"ESCOLAS","sheetName":"Escolas","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"ESTOQUE_ESCOLAR":{"entity":"ESTOQUE_ESCOLAR","sheetName":"Estoque_Escolar","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"FICHAS_TECNICAS":{"entity":"FICHAS_TECNICAS","sheetName":"Fichas_Tecnicas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"FORN_FORNECEDORES":{"entity":"FORN_FORNECEDORES","sheetName":"FORN_Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"FORNECEDORES":{"entity":"FORNECEDORES","sheetName":"Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"GLOSAS":{"entity":"GLOSAS","sheetName":"Glosas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"GRUPOS_NUTRICIONAIS":{"entity":"GRUPOS_NUTRICIONAIS","sheetName":"Grupos_Nutricionais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"HORTA_ESCOLAR":{"entity":"HORTA_ESCOLAR","sheetName":"Horta_Escolar","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"_SETUP_Project.gs"},"INSTRUCOES":{"entity":"INSTRUCOES","sheetName":"_INSTRUCOES","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"ITENS_ALIMENTARES":{"entity":"ITENS_ALIMENTARES","sheetName":"Itens_Alimentares","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"ITENS_CARDAPIO":{"entity":"ITENS_CARDAPIO","sheetName":"Itens_Cardapio","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Builder.gs"},"LISTAS_COMPRAS":{"entity":"LISTAS_COMPRAS","sheetName":"Listas_Compras","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Purchase_List.gs"},"LOG_SISTEMA":{"entity":"LOG_SISTEMA","sheetName":"LOG_Sistema","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Enterprise_Audit.gs"},"METAS_NUTRICIONAIS":{"entity":"METAS_NUTRICIONAIS","sheetName":"Metas_Nutricionais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"NF_ITENS":{"entity":"NF_ITENS","sheetName":"NF_Itens","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"NF_NOTAS_FISCAIS":{"entity":"NF_NOTAS_FISCAIS","sheetName":"NF_NotasFiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"NFS":{"entity":"NFS","sheetName":"Workflow_NotasFiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Workflow_Repository.gs"},"NOTAS":{"entity":"NOTAS","sheetName":"Notas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"NOTAS_FISCAIS":{"entity":"NOTAS_FISCAIS","sheetName":"Notas_Fiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"_INIT_Main.gs"},"NOTASFISCAIS":{"entity":"NOTASFISCAIS","sheetName":"Notasfiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_CRUD_Frontend_Bridge.gs"},"NOTIFICACOES_ALIMENTOS":{"entity":"NOTIFICACOES_ALIMENTOS","sheetName":"Notificacoes_Alimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Notificacao_Alimentos.gs"},"NUT_AVALIACOES":{"entity":"NUT_AVALIACOES","sheetName":"NUT_Avaliacoes","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"OCORRENCIAS":{"entity":"OCORRENCIAS","sheetName":"Workflow_Ocorrencias","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Workflow_Repository.gs"},"OCORRENCIAS_DESCARTE":{"entity":"OCORRENCIAS_DESCARTE","sheetName":"Ocorrencias_Descarte","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"PAGAMENTOS":{"entity":"PAGAMENTOS","sheetName":"Pagamentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"PARECERES":{"entity":"PARECERES","sheetName":"Pareceres_Tecnicos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Workflow.gs"},"PARECERES_TECNICOS":{"entity":"PARECERES_TECNICOS","sheetName":"Pareceres_Tecnicos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"PDGA":{"entity":"PDGA","sheetName":"PDGA","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"PDGP":{"entity":"PDGP","sheetName":"PDGP","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"PDGPS":{"entity":"PDGPS","sheetName":"Pdgps","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Analises.gs"},"PRECOS_ANTIECONOMICOS":{"entity":"PRECOS_ANTIECONOMICOS","sheetName":"Precos_Antieconomicos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Analises.gs"},"PRECOS_HISTORICO":{"entity":"PRECOS_HISTORICO","sheetName":"Precos_Historico","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"PROBLEMAS_FORNECEDORES":{"entity":"PROBLEMAS_FORNECEDORES","sheetName":"Problemas_Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Fornecedores.gs"},"PROCESSOS_ATESTO":{"entity":"PROCESSOS_ATESTO","sheetName":"Processos_Atesto","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"PRODUTOS":{"entity":"PRODUTOS","sheetName":"Produtos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"RASTREABILIDADE_PROCESSOS":{"entity":"RASTREABILIDADE_PROCESSOS","sheetName":"Rastreabilidade_Processos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Conformidade_Auditoria.gs"},"REC_RECUSAS":{"entity":"REC_RECUSAS","sheetName":"REC_Recusas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"RECEBIMENTO_GENEROS":{"entity":"RECEBIMENTO_GENEROS","sheetName":"Recebimento_Generos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"RECEBIMENTOS":{"entity":"RECEBIMENTOS","sheetName":"Workflow_Recebimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Workflow_Repository.gs"},"RECUSAS":{"entity":"RECUSAS","sheetName":"Recusas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Analises_Frontend.gs"},"REF_FORNECEDORES":{"entity":"REF_FORNECEDORES","sheetName":"Ref_Fornecedores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Infra_Manutencao.gs"},"RELATORIO_GLOSAS":{"entity":"RELATORIO_GLOSAS","sheetName":"Relatorio_Glosas","headers":["ID","Title","Type","Period","Status","GeneratedAt","GeneratedBy","Url","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Dominio_Empenhos.gs"},"REPOSICOES_ALIMENTOS":{"entity":"REPOSICOES_ALIMENTOS","sheetName":"Reposicoes_Alimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Notificacao_Alimentos.gs"},"RESTO_INGESTAO":{"entity":"RESTO_INGESTAO","sheetName":"Resto_Ingestao","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Waste_Tracker.gs"},"SESSOES":{"entity":"SESSOES","sheetName":"Sessoes","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"SETTINGS":{"entity":"SETTINGS","sheetName":"Settings","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"baseline"},"STATUS":{"entity":"STATUS","sheetName":"Status","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_UX_Feedback.gs"},"SUBSTITUICOES":{"entity":"SUBSTITUICOES","sheetName":"Substituicoes_Alimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Special_Menus.gs"},"SUBSTITUICOES_ALIMENTOS":{"entity":"SUBSTITUICOES_ALIMENTOS","sheetName":"Substituicoes_Alimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"SYSTEM_LOGS":{"entity":"SYSTEM_LOGS","sheetName":"System_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Migrations.gs"},"TEST_REPORTS":{"entity":"TEST_REPORTS","sheetName":"Test_Reports","headers":["ID","Title","Type","Period","Status","GeneratedAt","GeneratedBy","Url","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Infra_Testes.gs"},"TEXTOS_PADRAO":{"entity":"TEXTOS_PADRAO","sheetName":"Textos_Padrao","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"UNIDADES_ESCOLARES":{"entity":"UNIDADES_ESCOLARES","sheetName":"Unidades_Escolares","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Schema_Definition.gs"},"USERS":{"entity":"USERS","sheetName":"Users","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"USR_USUARIOS":{"entity":"USR_USUARIOS","sheetName":"Usr_Usuarios","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"_INIT_Main.gs"},"USUARIOS":{"entity":"USUARIOS","sheetName":"Usuarios","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"_DOCS_Code_Standards.gs"},"VERIFICACOES_COMPLETAS":{"entity":"VERIFICACOES_COMPLETAS","sheetName":"Verificacoes_Completas","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Conformidade_Auditoria.gs"},"VERIFICACOES_CONFORMIDADE":{"entity":"VERIFICACOES_CONFORMIDADE","sheetName":"Verificacoes_Conformidade","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Conformidade_Auditoria.gs"},"VIOLACOES":{"entity":"VIOLACOES","sheetName":"Violacoes","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"WORKFLOW_ANALISES":{"entity":"WORKFLOW_ANALISES","sheetName":"Workflow_Analises","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"WORKFLOW_HISTORICO":{"entity":"WORKFLOW_HISTORICO","sheetName":"Workflow_Historico","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Menu_Workflow.gs"},"WORKFLOW_NOTAS_FISCAIS":{"entity":"WORKFLOW_NOTAS_FISCAIS","sheetName":"Workflow_NotasFiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"},"WORKFLOW_NOTASFISCAIS":{"entity":"WORKFLOW_NOTASFISCAIS","sheetName":"Workflow_Notasfiscais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_CRUD_Frontend_Bridge.gs"},"WORKFLOW_RECEBIMENTOS":{"entity":"WORKFLOW_RECEBIMENTOS","sheetName":"Workflow_Recebimentos","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Core_Constants_Sheets.gs"}};
...
var SYNTHETIC_USERS_LOGIN_SCHEMAS = [
  { sheetName: 'Usuarios', headers: ['ID','Username','Password','Role','nome','email','senha','tipo','status'] }
];
...
var SchemaService = (function() {
  ...
  function ensureAllSheets(options) {
    try {
      ...
      if (options.seedAdminUsers !== false) {
        try { seedSyntheticUsers(options); } catch (seedError) {}
      }
      return ensured;
    } catch (error) {
  ...
  function syntheticAdminUserValue_(header, user, nowStr) {
    try {
      ...
      if (n.indexOf('role') >= 0 || n.indexOf('perfil') >= 0 || n.indexOf('papel') >= 0 || n.indexOf('nivel') >= 0 || n === 'tipo' || n.indexOf('tipousuario') >= 0) return user.role;
...
// ============================================================================
// P14 — Credenciais de seed centralizadas (fonte unica de verdade do SGAE).
// Senhas em TEXTO PLANO por decisao vigente da frota (sem hash nesta rodada).
// Os arquivos de seed (Core_Schema_Usuarios.gs, Setup_Dados_Teste.gs e
// Setup_Usuarios_DF.gs) leem daqui via getSeedCredential_() em getters lazy,
// eliminando senhas literais espalhadas pelo codigo versionado.
// ============================================================================
var SGAE_SEED_CREDENTIALS = {
  'admin@uniae.gov.br': 'Admin@2025',
  'analista@uniae.gov.br': 'Analista@2025',
  'fiscal@uniae.gov.br': 'Fiscal@2025',
  'gestor@uniae.gov.br': 'Gestor@2025',
  'escola@seedf.gov.br': 'Escola@2025',
  'fornecedor@empresa.com.br': 'Fornecedor@2025',
  'nutricionista@seedf.gov.br': 'Nutri@2025',
  'teste@teste.com': 'Teste@123',
  'admin.seedf@se.df.gov.br': 'Admin@SEEDF2025',
  'coord.crepp@se.df.gov.br': 'Coord@CREPP2025',
  'nutricionista.crepp@se.df.gov.br': 'Nutri@CREPP2025',
  'diretor.ec308sul@se.df.gov.br': 'Diretor@EC308',
  'analista.crepp@se.df.gov.br': 'Analista@CREPP2025',
  'consulta@se.df.gov.br': 'Consulta@2025'
};

/**
 * Retorna a senha-semente centralizada para o e-mail informado.
 * Chamado em runtime (getters lazy) — seguro quanto a ordem de load (.gs).
 */
function getSeedCredential_(email) {
  try {
    return SGAE_SEED_CREDENTIALS[String(email || '').toLowerCase()] || '';
  } catch (error) {
    Logger.log("Erro em getSeedCredential_: " + error.message);
    throw error;
  }
}
...
function seedSyntheticAiData(options) {
  try {
    try {
      options = options || {};
      var ss = options.spreadsheet || (typeof getSS === 'function' ? getSS() : getBoundSpreadsheet_());
