...
var MenuExporter = (function() {
  ...
  function _formatarDataCurta(data) {
    try {
      ...
      Logger.log("Erro em _formatarDataCurta: " + error.message);
      throw error;
    }
  }
...
<body>`;
  ...
  function _organizarEmSemanas(dados, mesAno) {
    try {
      ...
      Logger.log("Erro em _organizarEmSemanas: " + error.message);
      throw error;
    }
  }
  ...
  function _buscarDadosDia(dados, data) {
    try {
      ...
      Logger.log("Erro em _buscarDadosDia: " + error.message);
      throw error;
    }
  }
  ...
  function exportarSemanaPDF(options) {
    try {
      ...
      Logger.log("Erro em exportarSemanaPDF: " + error.message);
      throw error;
    }
  }
  ...
  function listarPDFsGerados(options) {
    try {
      ...
      Logger.log("Erro em listarPDFsGerados: " + error.message);
      throw error;
    }
  }
  ...
  function enviarPorEmail(options) {
    try {
      ...
      Logger.log("Erro em enviarPorEmail: " + error.message);
      throw error;
    }
  }
...
(function() {
  ...
  try {
    ...
    Logger.log('[' + moduleName + '] Funções: exportarPDF, exportarSemanaPDF, enviarPorEmail');
